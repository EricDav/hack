...
<head>
    ...
    <link rel="stylesheet" href="<?=$subPath . 'assets/css/owl.theme.default.min.css'?>">

    <link rel="stylesheet" href="<?=$subPath . 'assets/css/owl.carousel.min.css'?>">

    <link rel="stylesheet" href="<?=$subPath . 'assets/css/magnific-popup.min.css'?>">

    <link rel="stylesheet" href="<?=$subPath . 'assets/css/animate.min.css'?>">
    ...
    <link rel="stylesheet" href="<?=$subPath . 'assets/css/nice-select.min.css'?>">

    <link rel="stylesheet" href="<?=$subPath . 'assets/css/odometer.min.css'?>">

    <link rel="stylesheet" href="<?=$subPath . 'assets/css/style.css'?>">
        ...
        <div class="nav-area nav-area-three">
            <div class="navbar-area">
                ...
                <div class="mobile-nav">
                    <a href="index.html" class="logo">LegitHack</a>
                </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse mean-menu">
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="contact.html" class="nav-link">Testimonials</a>
                                    </li>
                                </ul>
                    ...
                    <div class="single-widget contact">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span>Address:</span> 658 Lane Drive st Riverside. California
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- /GetButton.io widget -->
    ...
    <script src="<?=$subPath . 'assets/js/jquery.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/bootstrap.bundle.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/meanmenu.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/owl.carousel.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/carousel-thumbs.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/wow.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/nice-select.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/magnific-popup.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/ofi.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/jarallax.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/appear.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/odometer.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/form-validator.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/contact-form-script.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/ajaxchimp.min.js'?>"></script>

    <script src="<?=$subPath . 'assets/js/custom.js'?>"></script>
</body>
